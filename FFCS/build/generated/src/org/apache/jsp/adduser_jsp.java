...
public final class adduser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(request.getParameter("enr").equals("student")) 
    {
        ...
        String kutte = "insert into student values('"+ request.getParameter("name")+ "','','" + request.getParameter("g") + "','','" + r + "','" + request.getParameter("email") + "','"+ request.getParameter("psw")+ "')";
        out.println("<h1>Registration No : " + r + "</h1>");
        rs.close();
        st.executeUpdate(kutte);
